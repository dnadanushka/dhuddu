...
//
//class OnBoardingAdvertiserScreen extends StatelessWidget {
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                SizedBox(
                  height: SizeConfig.safeBlockVertical * 40,
                  child: Image.asset('assets/increase_sales.png'),
                ),
                Text(
                  'Increase Sales',
                  style: TextStyle(
...
class OnBoardingAdvertiserScreen extends StatefulWidget {
  static const routeName = '/on-bording-advertiser';

  @override
  _OnBoardingAdvertiserScreenState createState() =>
      _OnBoardingAdvertiserScreenState();
}

class _OnBoardingAdvertiserScreenState extends State<OnBoardingAdvertiserScreen> {
  bool isLast = false;
